!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="../",__webpack_require__(0)}([function(module,exports,__webpack_require__){module.exports=__webpack_require__(5)},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
...
options.crossDomain||headers["X-Requested-With"]||(headers["X-Requested-With"]="XMLHttpRequest");for(i in headers)xhr.setRequestHeader(i,headers[i]);callback=function(type){return function(){callback&&(callback=errorCallback=xhr.onload=xhr.onerror=xhr.onabort=xhr.onreadystatechange=null,"abort"===type?xhr.abort():"error"===type?"number"!=typeof xhr.status?complete(0,"error"):complete(xhr.status,xhr.statusText):complete(xhrSuccessStatus[xhr.status]||xhr.status,xhr.statusText,"text"!==(xhr.responseType||"text")||"string"!=typeof xhr.responseText?{binary:xhr.response}:{text:xhr.responseText},xhr.getAllResponseHeaders()))}},xhr.onload=callback(),errorCallback=xhr.onerror=callback("error"),void 0!==xhr.onabort?xhr.onabort=errorCallback:xhr.onreadystatechange=function(){4===xhr.readyState&&window.setTimeout(function(){callback&&errorCallback()})},callback=callback("abort");try{xhr.send(options.hasContent&&options.data||null)}catch(e){if(callback)throw e}},abort:function(){callback&&callback()}}}),jQuery.ajaxPrefilter(function(s){s.crossDomain&&(s.contents.script=!1)}),jQuery.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(text){return jQuery.globalEval(text),text}}}),jQuery.ajaxPrefilter("script",function(s){void 0===s.cache&&(s.cache=!1),s.crossDomain&&(s.type="GET")}),jQuery.ajaxTransport("script",function(s){if(s.crossDomain){var script,callback;return{send:function(_,complete){script=jQuery("<script>").prop({charset:s.scriptCharset,src:s.url}).on("load error",callback=function(evt){script.remove(),callback=null,evt&&complete("error"===evt.type?404:200,evt.type)}),document.head.appendChild(script[0])},abort:function(){callback&&callback()}}}});var oldCallbacks=[],rjsonp=/(=)\?(?=&|$)|\?\?/;jQuery.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var callback=oldCallbacks.pop()||jQuery.expando+"_"+nonce++;return this[callback]=!0,callback}}),jQuery.ajaxPrefilter("json jsonp",function(s,originalSettings,jqXHR){var callbackName,overwritten,responseContainer,jsonProp=s.jsonp!==!1&&(rjsonp.test(s.url)?"url":"string"==typeof s.data&&0===(s.contentType||"").indexOf("application/x-www-form-urlencoded")&&rjsonp.test(s.data)&&"data");if(jsonProp||"jsonp"===s.dataTypes[0])return callbackName=s.jsonpCallback=jQuery.isFunction(s.jsonpCallback)?s.jsonpCallback():s.jsonpCallback,jsonProp?s[jsonProp]=s[jsonProp].replace(rjsonp,"$1"+callbackName):s.jsonp!==!1&&(s.url+=(rquery.test(s.url)?"&":"?")+s.jsonp+"="+callbackName),s.converters["script json"]=function(){return responseContainer||jQuery.error(callbackName+" was not called"),responseContainer[0]},s.dataTypes[0]="json",overwritten=window[callbackName],window[callbackName]=function(){responseContainer=arguments},jqXHR.always(function(){void 0===overwritten?jQuery(window).removeProp(callbackName):window[callbackName]=overwritten,s[callbackName]&&(s.jsonpCallback=originalSettings.jsonpCallback,oldCallbacks.push(callbackName)),responseContainer&&jQuery.isFunction(overwritten)&&overwritten(responseContainer[0]),responseContainer=overwritten=void 0}),"script"}),support.createHTMLDocument=function(){var body=document.implementation.createHTMLDocument("").body;return body.innerHTML="<form></form><form></form>",2===body.childNodes.length}(),jQuery.parseHTML=function(data,context,keepScripts){if("string"!=typeof data)return[];"boolean"==typeof context&&(keepScripts=context,context=!1);var base,parsed,scripts;return context||(support.createHTMLDocument?(context=document.implementation.createHTMLDocument(""),base=context.createElement("base"),base.href=document.location.href,context.head.appendChild(base)):context=document),parsed=rsingleTag.exec(data),scripts=!keepScripts&&[],parsed?[context.createElement(parsed[1])]:(parsed=buildFragment([data],context,scripts),scripts&&scripts.length&&jQuery(scripts).remove(),jQuery.merge([],parsed.childNodes))},jQuery.fn.load=function(url,params,callback){var selector,type,response,self=this,off=url.indexOf(" ");return off>-1&&(selector=stripAndCollapse(url.slice(off)),url=url.slice(0,off)),jQuery.isFunction(params)?(callback=params,params=void 0):params&&"object"==typeof params&&(type="POST"),self.length>0&&jQuery.ajax({url:url,type:type||"GET",dataType:"html",data:params}).done(function(responseText){response=arguments,self.html(selector?jQuery("<div>").append(jQuery.parseHTML(responseText)).find(selector):responseText)}).always(callback&&function(jqXHR,status){self.each(function(){callback.apply(this,response||[jqXHR.responseText,status,jqXHR])})}),this},jQuery.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(i,type){jQuery.fn[type]=function(fn){return this.on(type,fn)}}),jQuery.expr.pseudos.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length},jQuery.offset={setOffset:function(elem,options,i){var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&(curCSSTop+curCSSLeft).indexOf("auto")>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,jQuery.extend({},curOffset))),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,rect,doc,elem=this[0];if(elem)return elem.getClientRects().length?(rect=elem.getBoundingClientRect(),rect.width||rect.height?(doc=elem.ownerDocument,win=getWindow(doc),docElem=doc.documentElement,{top:rect.top+win.pageYOffset-docElem.clientTop,left:rect.left+win.pageXOffset-docElem.clientLeft}):rect):{top:0,left:0}},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset={top:parentOffset.top+jQuery.css(offsetParent[0],"borderTopWidth",!0),left:parentOffset.left+jQuery.css(offsetParent[0],"borderLeftWidth",!0)}),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent;offsetParent&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?win.pageXOffset:val,top?val:win.pageYOffset):elem[method]=val)},method,val,arguments.length)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){if(computed)return computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?0===funcName.indexOf("outer")?elem["inner"+name]:elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable)}})}),jQuery.fn.extend({bind:function(types,data,fn){return this.on(types,null,data,fn)},unbind:function(types,fn){return this.off(types,null,fn)},delegate:function(selector,types,data,fn){return this.on(types,selector,data,fn)},undelegate:function(selector,types,fn){return 1===arguments.length?this.off(selector,"**"):this.off(types,selector||"**",fn)}}),jQuery.parseJSON=JSON.parse,__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_RESULT__=function(){return jQuery}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),!(void 0!==__WEBPACK_AMD_DEFINE_RESULT__&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__));var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},noGlobal||(window.jQuery=window.$=jQuery),jQuery})},function(module,exports,__webpack_require__){(function(setImmediate,clearImmediate){function Timeout(id,clearFn){this._id=id,this._clearFn=clearFn}var nextTick=__webpack_require__(37).nextTick,apply=Function.prototype.apply,slice=Array.prototype.slice,immediateIds={},nextImmediateId=0;exports.setTimeout=function(){return new Timeout(apply.call(setTimeout,window,arguments),clearTimeout)},exports.setInterval=function(){return new Timeout(apply.call(setInterval,window,arguments),clearInterval)},exports.clearTimeout=exports.clearInterval=function(timeout){timeout.close()},Timeout.prototype.unref=Timeout.prototype.ref=function(){},Timeout.prototype.close=function(){this._clearFn.call(window,this._id)},exports.enroll=function(item,msecs){clearTimeout(item._idleTimeoutId),item._idleTimeout=msecs},exports.unenroll=function(item){clearTimeout(item._idleTimeoutId),item._idleTimeout=-1},exports._unrefActive=exports.active=function(item){clearTimeout(item._idleTimeoutId);var msecs=item._idleTimeout;msecs>=0&&(item._idleTimeoutId=setTimeout(function(){item._onTimeout&&item._onTimeout()},msecs))},exports.setImmediate="function"==typeof setImmediate?setImmediate:function(fn){var id=nextImmediateId++,args=!(arguments.length<2)&&slice.call(arguments,1);return immediateIds[id]=!0,nextTick(function(){immediateIds[id]&&(args?fn.apply(null,args):fn.call(null),exports.clearImmediate(id))}),id},exports.clearImmediate="function"==typeof clearImmediate?clearImmediate:function(id){delete immediateIds[id]}}).call(exports,__webpack_require__(2).setImmediate,__webpack_require__(2).clearImmediate)},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_FACTORY__,__WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;!function(factory){"use strict";__WEBPACK_AMD_DEFINE_ARRAY__=[__webpack_require__(1)],__WEBPACK_AMD_DEFINE_FACTORY__=factory,__WEBPACK_AMD_DEFINE_RESULT__="function"==typeof __WEBPACK_AMD_DEFINE_FACTORY__?__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__):__WEBPACK_AMD_DEFINE_FACTORY__,!(void 0!==__WEBPACK_AMD_DEFINE_RESULT__&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__))}(function($){var _previousResizeWidth=-1,_updateTimeout=-1,_parse=function(value){return parseFloat(value)||0},_rows=function(elements){var tolerance=1,$elements=$(elements),lastTop=null,rows=[];return $elements.each(function(){var $that=$(this),top=$that.offset().top-_parse($that.css("margin-top")),lastRow=rows.length>0?rows[rows.length-1]:null;null===lastRow?rows.push($that):Math.floor(Math.abs(lastTop-top))<=tolerance?rows[rows.length-1]=lastRow.add($that):rows.push($that),lastTop=top}),rows},_parseOptions=function(options){var opts={byRow:!0,property:"height",target:null,remove:!1};return"object"==typeof options?$.extend(opts,options):("boolean"==typeof options?opts.byRow=options:"remove"===options&&(opts.remove=!0),opts)},matchHeight=$.fn.matchHeight=function(options){var opts=_parseOptions(options);if(opts.remove){var that=this;return this.css(opts.property,""),$.each(matchHeight._groups,function(key,group){group.elements=group.elements.not(that)}),this}return this.length<=1&&!opts.target?this:(matchHeight._groups.push({elements:this,options:opts}),matchHeight._apply(this,opts),this)};matchHeight.version="0.7.0",matchHeight._groups=[],matchHeight._throttle=80,matchHeight._maintainScroll=!1,matchHeight._beforeUpdate=null,matchHeight._afterUpdate=null,matchHeight._rows=_rows,matchHeight._parse=_parse,matchHeight._parseOptions=_parseOptions,matchHeight._apply=function(elements,options){var opts=_parseOptions(options),$elements=$(elements),rows=[$elements],scrollTop=$(window).scrollTop(),htmlHeight=$("html").outerHeight(!0),$hiddenParents=$elements.parents().filter(":hidden");return $hiddenParents.each(function(){var $that=$(this);$that.data("style-cache",$that.attr("style"))}),$hiddenParents.css("display","block"),opts.byRow&&!opts.target&&($elements.each(function(){var $that=$(this),display=$that.css("display");"inline-block"!==display&&"flex"!==display&&"inline-flex"!==display&&(display="block"),$that.data("style-cache",$that.attr("style")),$that.css({display:display,"padding-top":"0","padding-bottom":"0","margin-top":"0","margin-bottom":"0","border-top-width":"0","border-bottom-width":"0",height:"100px",overflow:"hidden"})}),rows=_rows($elements),$elements.each(function(){var $that=$(this);$that.attr("style",$that.data("style-cache")||"")})),$.each(rows,function(key,row){var $row=$(row),targetHeight=0;if(opts.target)targetHeight=opts.target.outerHeight(!1);else{if(opts.byRow&&$row.length<=1)return void $row.css(opts.property,"");$row.each(function(){var $that=$(this),style=$that.attr("style"),display=$that.css("display");"inline-block"!==display&&"flex"!==display&&"inline-flex"!==display&&(display="block");var css={display:display};css[opts.property]="",$that.css(css),$that.outerHeight(!1)>targetHeight&&(targetHeight=$that.outerHeight(!1)),style?$that.attr("style",style):$that.css("display","")})}$row.each(function(){var $that=$(this),verticalPadding=0;opts.target&&$that.is(opts.target)||("border-box"!==$that.css("box-sizing")&&(verticalPadding+=_parse($that.css("border-top-width"))+_parse($that.css("border-bottom-width")),verticalPadding+=_parse($that.css("padding-top"))+_parse($that.css("padding-bottom"))),$that.css(opts.property,targetHeight-verticalPadding+"px"))})}),$hiddenParents.each(function(){var $that=$(this);$that.attr("style",$that.data("style-cache")||null)}),matchHeight._maintainScroll&&$(window).scrollTop(scrollTop/htmlHeight*$("html").outerHeight(!0)),this},matchHeight._applyDataApi=function(){var groups={};$("[data-match-height], [data-mh]").each(function(){var $this=$(this),groupId=$this.attr("data-mh")||$this.attr("data-match-height");groupId in groups?groups[groupId]=groups[groupId].add($this):groups[groupId]=$this}),$.each(groups,function(){this.matchHeight(!0)})};var _update=function(event){matchHeight._beforeUpdate&&matchHeight._beforeUpdate(event,matchHeight._groups),$.each(matchHeight._groups,function(){matchHeight._apply(this.elements,this.options)}),matchHeight._afterUpdate&&matchHeight._afterUpdate(event,matchHeight._groups)};matchHeight._update=function(throttle,event){if(event&&"resize"===event.type){var windowWidth=$(window).width();if(windowWidth===_previousResizeWidth)return;_previousResizeWidth=windowWidth}throttle?_updateTimeout===-1&&(_updateTimeout=setTimeout(function(){_update(event),_updateTimeout=-1},matchHeight._throttle)):_update(event)},$(matchHeight._applyDataApi),$(window).bind("load",function(event){matchHeight._update(!1,event)}),$(window).bind("resize orientationchange",function(event){matchHeight._update(!0,event)})})},function(module,exports){function parse(html,doc){if("string"!=typeof html)throw new TypeError("String expected");doc||(doc=document);var m=/<([\w:]+)/.exec(html);if(!m)return doc.createTextNode(html);html=html.replace(/^\s+|\s+$/g,"");var tag=m[1];if("body"==tag){var el=doc.createElement("html");return el.innerHTML=html,el.removeChild(el.lastChild)}var wrap=map[tag]||map._default,depth=wrap[0],prefix=wrap[1],suffix=wrap[2],el=doc.createElement("div");for(el.innerHTML=prefix+html+suffix;depth--;)el=el.lastChild;if(el.firstChild==el.lastChild)return el.removeChild(el.firstChild);for(var fragment=doc.createDocumentFragment();el.firstChild;)fragment.appendChild(el.removeChild(el.firstChild));return fragment}module.exports=parse;var bugTestDiv,innerHTMLBug=!1;"undefined"!=typeof document&&(bugTestDiv=document.createElement("div"),bugTestDiv.innerHTML='  <link/><table></table><a href="/a">a</a><input type="checkbox"/>',innerHTMLBug=!bugTestDiv.getElementsByTagName("link").length,bugTestDiv=void 0);var map={legend:[1,"<fieldset>","</fieldset>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],_default:innerHTMLBug?[1,"X<div>","</div>"]:[0,"",""]};map.td=map.th=[3,"<table><tbody><tr>","</tr></tbody></table>"],map.option=map.optgroup=[1,'<select multiple="multiple">',"</select>"],map.thead=map.tbody=map.colgroup=map.caption=map.tfoot=[1,"<table>","</table>"],map.polyline=map.ellipse=map.polygon=map.circle=map.text=map.line=map.path=map.rect=map.g=[1,'<svg xmlns="http://www.w3.org/2000/svg" version="1.1">',"</svg>"]},function(module,exports,__webpack_require__){__webpack_require__(30),__webpack_require__(31)},function(module,exports,__webpack_require__){(function($){var AccordionHandler={init:function(){var _accordion=document.querySelectorAll(".accordion"),_triggers=$(_accordion).find(".accordion-trigger");null!==_triggers&&$(_triggers).on("click",function(e){var $this=$(this),$parent=$(this).parent(),$submenu=$parent.find("> .submenu");return $this.trigger("resize-start"),$parent.toggleClass("is-expanded"),$submenu.stop().slideToggle(300,"easeOutSine",function(){if(!$parent.hasClass("is-expanded")){var $submenus=$submenu.find(".is-expanded");$submenus.removeClass("is-expanded"),$submenus.find("> .submenu").slideUp(0)}$this.trigger("resize-end")}),!1})}};!function(){"undefined"!=typeof useAccordion&&useAccordion&&AccordionHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var AccordionTabsHandler={items:[],init:function(){var _accordiontabs=document.querySelectorAll(".accordion-tabs"),_triggers=$(_accordiontabs).find(".accordion-trigger");null!==_triggers&&($.each($(_accordiontabs),function(i,item){$(item).find("> li:first-child").addClass("is-expanded").find(".accordion-content").show()}),$(_triggers).on("click",function(e){var $this=$(this),$accordiontabs=$(this).closest(".accordion-tabs");return $.each($accordiontabs,function(i,item){$(item).find("> li").removeClass("is-expanded").find(".accordion-content").hide()}),$this.parent().addClass("is-expanded").find(".accordion-content").show(),!1}))}};!function(){"undefined"!=typeof useAccordionTabs&&useAccordionTabs&&AccordionTabsHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){NewsHandler={id:"",apiUrl:window.location.origin+"/sitecore/api/ssc/norra/",newsUrl:"News/1337/GetNews",calendarUrl:"Calendar/1337/GetCalendar",pressUrl:"News/1337/GetPress",siteId:null,page:2,pageSize:3,$newsList:null,$newsItem:null,items:[],$loadmore:null,$filter:null,$filterLoader:null,$noResult:null,createNewList:!1,usePress:!1,init:function(SiteId,Id,usePress){this.siteId=SiteId,this.id=Id,this.usePress=usePress;var _newsList=document.getElementById(Id+"-list-template"),_newsItem=document.getElementById(Id+"-item-template");if(null===_newsList||null===_newsItem)return void console.log("Associated DOM elements not found!");this.$newsList=$(_newsList),this.$newsItem=$(_newsItem),this.$newsList.removeAttr("id"),this.$newsItem.removeAttr("id"),this.$newsItem.remove();var _li=_newsList.querySelectorAll("li");$.each(_li,function(i,item){this.items.push(item)}.bind(this));var _loadmore=document.querySelector(".load-more");null!==_loadmore&&(this.$loadmore=$(_loadmore),this.$loadmore.on("click",function(e){return!this.$loadmore.hasClass("loading")&&(this.createNewList=!1,this.$loadmore.height(this.$loadmore.height()),this.$loadmore.width(this.$loadmore.width()),this.$loadmore.addClass("loading"),setTimeout(function(){this.getNews(this.createNewsItems)}.bind(this),600),!1)}.bind(this)));var _filter=document.getElementById("select_year");null!==_filter&&(this.$filter=$(_filter),this.$filterLoader=$(_filter.nextElementSibling),this.$filter.on("change",function(e){var year="All"==this.value?-1:this.value;return NewsHandler.createNewList=!0,NewsHandler.page=1,NewsHandler.$newsList.addClass("loading"),NewsHandler.$filter.attr("disabled","disabled"),NewsHandler.$filterLoader.addClass("show"),setTimeout(function(){NewsHandler.getNews(NewsHandler.createNewsItems,year)},600),!1}));var _noresult=document.querySelector(".no-result");null!==_noresult&&(this.$noResult=$(_noresult))},loadNewsList:function(){this.getNews(this.createNewsItems)},loadNewsLatestList:function(){this.getNews(this.createNewsLatestItems)},clearNewsList:function(){NewsHandler.items.length&&$.each(NewsHandler.items,function(i,item){item.parentNode.removeChild(item)}),NewsHandler.items=[]},createNewsLatestItems:function(data){data.length<NewsHandler.pageSize,$.each(data,function(i,item){var _clone=NewsHandler.$newsItem.clone()[0];_clone.querySelector(".title").innerHTML=item.Title;var date=new Date(item.Date);_clone.querySelector(".day").innerHTML=("0"+date.getDate()).slice(-2),_clone.querySelector(".month").innerHTML=("0"+(date.getMonth()+1)).slice(-2),_clone.querySelector(".year").innerHTML=date.getFullYear(),_clone.querySelector(".title").setAttribute("href",window.location.origin+item.Link.replace("http://","")),NewsHandler.items.push(_clone),NewsHandler.$newsList.append($(_clone))}),NewsHandler.items.length?NewsHandler.$newsList.hasClass("show")||NewsHandler.$newsList.addClass("show"):NewsHandler.$noResult.hasClass("show")||NewsHandler.$noResult.addClass("show")},createNewsItems:function(data){NewsHandler.createNewList&&NewsHandler.clearNewsList(),data.length<NewsHandler.pageSize?NewsHandler.$loadmore.hasClass("hide")||NewsHandler.$loadmore.addClass("hide"):NewsHandler.$loadmore.hasClass("hide")&&NewsHandler.$loadmore.removeClass("hide");Language.toLowerCase();$.each(data,function(i,item){var _clone=NewsHandler.$newsItem.clone()[0];_clone.querySelector(".title").innerHTML=item.Title;var monthName=new Date(item.Date).toLocaleString(Language,{month:"long"}),date=item.Date.split("-");_clone.querySelector(".day").innerHTML=date[2],_clone.querySelector(".month").innerHTML=monthName,_clone.querySelector(".year").innerHTML=date[0];var _summary=_clone.querySelector(".summary");ScreensizeHandler.isMdOrSmaller||!item.Summary?_summary.parentNode.removeChild(_summary):_summary.innerHTML=item.Summary,_clone.querySelector(".text-link").setAttribute("href",item.Link);var _backgroundImage=_clone.querySelector(".background-image");ScreensizeHandler.isMdOrSmaller?_backgroundImage.parentNode.removeChild(_backgroundImage):"none"!=item.Image&&(_backgroundImage.style.backgroundImage=item.Image.replace('"',"")),0==NewsHandler.items.length,NewsHandler.items.push(_clone),NewsHandler.$newsList.append($(_clone))}),NewsHandler.$loadmore&&(NewsHandler.$loadmore.height(""),NewsHandler.$loadmore.width(""),NewsHandler.$loadmore.removeClass("loading")),NewsHandler.$filter&&(NewsHandler.$filter.removeAttr("disabled"),NewsHandler.$filterLoader.removeClass("show")),NewsHandler.createNewList&&(NewsHandler.createNewList=!1),NewsHandler.$newsList.hasClass("loading")&&NewsHandler.$newsList.removeClass("loading"),NewsHandler.items.length?(NewsHandler.$newsList.hasClass("show")||NewsHandler.$newsList.addClass("show"),NewsHandler.$noResult.hasClass("show")&&NewsHandler.$noResult.removeClass("show")):(NewsHandler.$newsList.hasClass("show")&&NewsHandler.$newsList.removeClass("show"),NewsHandler.$noResult.hasClass("show")||NewsHandler.$noResult.addClass("show"))},patch:function(){},getNews:function(handleData,year){year||(year=-1);var apiFunction;apiFunction=this.usePress?this.pressUrl:"news"==this.id?this.newsUrl:this.calendarUrl,$.getJSON({type:"GET",dataType:"json",url:this.apiUrl+apiFunction,data:{page:this.page,pageSize:this.pageSize,siteId:this.siteId,year:year},success:function(data){console.log(data),handleData(data)},error:function(e){console.log(e.message)}}),this.page+=1}},function(){"undefined"!=typeof SiteId&&("undefined"!=typeof useNewsApi&&useNewsApi?NewsHandler.init(SiteId,"news",!1):"undefined"!=typeof useCalendarApi&&useCalendarApi?NewsHandler.init(SiteId,"calendar",!1):"undefined"!=typeof usePressApi&&usePressApi&&NewsHandler.init(SiteId,"news",!0))}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){function hideArrow(){var _arrowdown=document.querySelector(".arrow-down");null!==_arrowdown&&$(_arrowdown).off("click").fadeOut(200)}!function(){var _arrowdown=document.querySelector(".arrow-down");null!==_arrowdown&&$(_arrowdown).on("click",function(e){return hideArrow(),$("html, body").animate({scrollTop:$(".content-wrapper").offset().top},1e3),!1})}(),$(window).on("load",function(){$(this).one("scroll",function(){hideArrow()})})}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var BackgroundImageHandler={init:function(){var _backgroundImages=document.querySelectorAll("picture.background-image");null!==_backgroundImages&&$(_backgroundImages).each(function(){var $this=$(this),$image=$this.find("> img"),src="";src=$image.prop("currentSrc")?$image.prop("currentSrc"):$image.prop("src"),$this.siblings(".background-image").css("background-image","url("+src+")"),$image.hasClass("use-gradient")&&$this.siblings(".background-image").css("background-image","linear-gradient(rgba(0, 0, 0, 0.27), rgba(0, 0, 0, 0.27)), url("+src+")"),$this.remove()})}};!function(){BackgroundImageHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var CarouselHandler={init:function(){var $carousel,$this=this,_carousels=document.querySelectorAll(".slick-carousel");null!==_carousels&&$(_carousels).each(function(){$carousel=$(this);var slidesToShow=$carousel.data("slidesToShow"),slidesToScroll=$carousel.data("slidesToScroll"),slidesLg=$carousel.data("slidesLg"),slidesMd=$carousel.data("slidesMd"),slidesSm=$carousel.data("slidesSm");slidesLg||(slidesLg=slidesToShow),slidesMd||(slidesMd=slidesLg),slidesSm||(slidesSm=slidesMd),$this.createSlickSlider($carousel,slidesToShow,slidesToScroll,slidesLg,slidesMd,slidesSm)})},createSlickSlider:function($carousel,slidesToShow,slidesToScroll,slidesLg,slidesMd,slidesSm){$carousel.slick({dots:!0,infinite:!1,speed:800,slidesToShow:slidesToShow,slidesToScroll:slidesToScroll,cssEsae:"ease-out",useTransform:!0,lazyLoad:"progressive",responsive:[{breakpoint:1024,settings:{slidesToShow:slidesLg,slidesToScroll:slidesLg}},{breakpoint:768,settings:{slidesToShow:slidesMd,slidesToScroll:slidesMd}},{breakpoint:480,settings:{slidesToShow:slidesSm,slidesToScroll:slidesSm}}]})}};!function(){"undefined"!=typeof useCarousel&&useCarousel&&(__webpack_require__(29),CarouselHandler.init())}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var CookieHandler={init:function(){this.checkCookie()},checkCookie:function(){var _this=this,cookie=this.readCookie("cookieAccepted"),_cookie=document.querySelector(".cookie");if(null!==_cookie){var $cookie=$(_cookie);cookie?$cookie.hasClass("hide")||$cookie.slideToggle():($cookie.removeClass("hide"),$(_cookie.querySelector(".accept")).on("click",function(e){return _this.createCookie("cookieAccepted","true",21),_this.checkCookie(),!1}))}},createCookie:function(name,value,days){if(days){var date=new Date;date.setTime(date.getTime()+24*days*60*60*1e3);var expires="; expires="+date.toGMTString()}else var expires="";document.cookie=name+"="+value+expires+"; path=/"},readCookie:function(name){for(var nameEQ=name+"=",ca=document.cookie.split(";"),i=0;i<ca.length;i++){for(var c=ca[i];" "==c.charAt(0);)c=c.substring(1,c.length);if(0==c.indexOf(nameEQ))return c.substring(nameEQ.length,c.length)}return null},eraseCookie:function(name){createCookie(name,"",-1)}};!function(){"undefined"!=typeof useCookie&&useCookie&&CookieHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){__webpack_require__(24),deKai={isMobile:!1,checkOS:function(){var isIE=this.detectIE();isIE&&isIE>9&&$("html").addClass("ie")},detectIE:function(){var ua=window.navigator.userAgent,msie=ua.indexOf("MSIE ");if(msie>0)return parseInt(ua.substring(msie+5,ua.indexOf(".",msie)),10);var trident=ua.indexOf("Trident/");if(trident>0){var rv=ua.indexOf("rv:");return parseInt(ua.substring(rv+3,ua.indexOf(".",rv)),10)}var edge=ua.indexOf("Edge/");return edge>0&&parseInt(ua.substring(edge+5,ua.indexOf(".",edge)),10)},checkDevice:function(){this.isMobile=this.detectMobile(),this.isMobile?$("body").addClass("has-touch"):$("body").addClass("no-touch"),isMobile=this.isMobile},detectMobile:function(){var check=!1;return function(a){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(a)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(a.substr(0,4)))&&(check=!0)}(navigator.userAgent||navigator.vendor||window.opera),check},addFastclick:function(){"addEventListener"in document&&document.addEventListener("DOMContentLoaded",function(){FastClick.attach(document.body)},!1)},hideOverlay:function(){$(document.getElementById("page-wrapper")).removeClass("visibility-hidden"),$(document.querySelector(".overlay")).delay(200).fadeOut(200);
}},function(){deKai.checkOS(),deKai.checkDevice()}(),$(window).on("load",function(){deKai.addFastclick(),deKai.hideOverlay()})}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var FlexsliderHandler={$pageslider:null,$pageheader:null,$flexslider:null,$slidertext:null,$figCaption:null,$directionNav:null,itemsVisible:!0,menuHeight:0,sliderHeight:0,init:function(){var _flexsliders=document.querySelector(".page-slider");null!==_flexsliders&&(this.$pageslider=$(_flexsliders),this.$flexslider=this.$pageslider.find(".flexslider"),this.$slidertext=this.$pageslider.find(".flexslider-figcaption"),this.$pageheader=$(".page-header"),this.$pageslider.find(".slides > li").each(function(){var $slide=$(this),$image=$(this.querySelector("img")),src="";src=$image.prop("currentSrc")?$image.prop("currentSrc"):$image.prop("src");var $flexsliderImage=$(this.querySelector(".flexslider-image"));$flexsliderImage.css("background-image","url("+src+")"),$image.hasClass("use-gradient")&&$flexsliderImage.css("background-image","linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url("+src+")"),$slide.find("picture").remove()}),this.$flexslider.flexslider({directionNav:!0,controlNav:!0,animationLoop:!0,slideshow:!1,slideshowSpeed:0,animation:"slide",useCSS:!0,startAt:0,init:function(slider){}.bind(this),start:function(slider){this.$directionNav=this.$flexslider.find(".flex-direction-nav a"),this.$figCaption=this.$pageslider.find(".flexslider-figcaption"),this.setTopPadding(),$(window).resize(function(){this.setTopPadding()}.bind(this)),$(window).scroll(function(){this.handleScroll()}.bind(this))}.bind(this),after:function(slider){}}))},setTopPadding:function(){this.menuHeight=this.$pageheader.outerHeight();var $subwebMenu=this.$pageheader.find(".subweb-menu");$subwebMenu.length&&(this.menuHeight-=this.$pageheader.find(".rootweb-menu").outerHeight()),this.$pageslider.css({top:this.menuHeight}),this.sliderHeight=$(window).height()/1.2-this.menuHeight,this.sliderHeight<400&&(this.sliderHeight=400),$("body").css({"padding-top":this.sliderHeight+this.menuHeight}),this.$flexslider.css({height:this.sliderHeight}),this.$figCaption.find(".content").css({top:-this.sliderHeight/2})},handleScroll:function(){if(!ScreensizeHandler.isLgOrSmaller){var scrollTop=$(window).scrollTop();scrollTop>=(this.sliderHeight+this.menuHeight)/2?this.itemsVisible&&(this.itemsVisible=!1,this.$figCaption.stop().fadeOut(400),this.$directionNav.stop().fadeOut(200)):this.itemsVisible||(this.itemsVisible=!0,this.$figCaption.stop().fadeIn(400),this.$directionNav.stop().fadeIn(200)),scrollTop<=this.sliderHeight+this.menuHeight&&(this.$pageslider.css({transform:"translateY(-"+scrollTop/2+"px)"}),this.$slidertext.css({transform:"translateY(-"+scroll/2+"px)"}))}}};!function(){"undefined"!=typeof useSlider&&useSlider&&(__webpack_require__(26),FlexsliderHandler.init())}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var ImagemapHandler={currentLan:null,init:function(){var _imageMap=document.getElementById("image-map");if(null!==_imageMap){var _paths=_imageMap.querySelectorAll("svg > path"),_this=(_imageMap.querySelectorAll(".lan-text"),this);$(_paths).on("click",function(e){var _clickedLan=document.getElementById(this.getAttribute("id")+"_text");_this.currentLan!=_clickedLan&&(_this.currentLan&&$(_this.currentLan).fadeOut(),$(_paths).removeClass("open"),_this.currentLan=_clickedLan,$(this).addClass("open"),$(_this.currentLan).fadeIn(function(){ScreensizeHandler.isLgOrSmaller&&$("html, body").animate({scrollTop:$(_this.currentLan).offset().top-40},600)}))})}}};!function(){"undefined"!=typeof useImageMap&&useImageMap&&ImagemapHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var LoginHandler={init:function(){$(".show-recovery").click(function(){$("#login").hide(),$("#passwordRecovery").show(),$("#UserNameForgot").removeAttr("disabled"),$("#UserName").attr({disabled:"disabled"}),$("#Password").attr({disabled:"disabled"}),$("#UserNameForgot").focus()}),$(".hide-recovery").click(function(){$("#passwordRecovery").hide(),$("#login").show(),$("#UserNameForgot").attr({disabled:"disabled"}),$("#UserName").removeAttr("disabled"),$("#Password").removeAttr("disabled"),$("#UserName").focus()}),$('#login input[type="submit"]').click(function(){return""===$("#UserName").val()||""===$("#Password").val()?($("#credentialsError").show(),$("#loginFailedMessage").hide(),!1):void $("#credentialsError").hide()}),$("#licenseOptionsLink").click(function(){$("#login").hide(),$("#licenseOptions").show()}),$("#licenseOptionsBack").click(function(){$("#licenseOptions").hide(),$("#login").show()})}};!function(){"undefined"!=typeof useLogin&&useLogin&&LoginHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){!function(){if(__webpack_require__(3),"undefined"!=typeof useGridSameHeight&&useGridSameHeight&&$("html").hasClass("ie-old")){var _sameheight=document.querySelectorAll(".same-height");null!==_sameheight&&$(_sameheight).find("> .column").matchHeight()}if("undefined"!=typeof useSlickSameHeight&&useSlickSameHeight){var _texts=document.querySelectorAll(".slick-carousel .title.match-height");null!==_texts&&$(_texts).matchHeight();var _cardTexts=document.querySelectorAll(".slick-carousel .card-text.match-height");null!==_cardTexts&&$(_cardTexts).matchHeight()}var _texts=document.querySelectorAll(".same-height .match-height");null!==_texts&&$(_texts).matchHeight();var _texts2=document.querySelectorAll(".same-height .match-height-title");null!==_texts2&&$(_texts2).matchHeight();var _texts3=document.querySelectorAll(".same-height .match-height-text");null!==_texts3&&$(_texts3).matchHeight()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var MenuScrollHandler={$pageheader:null,scrolledClass:"scrolled",hideClass:"slide-up",scrolled:!1,hidden:!1,senseSpeed:5,offsetTop:0,prevScrollTop:0,timer:null,$rootMenu:null,$subwebMenu:null,rootMenuHidden:!1,scrollDisabled:!1,init:function(){var _pageheader=document.querySelector(".page-header");null!==_pageheader&&(this.$pageheader=$(_pageheader),this.$subwebMenu=$(_pageheader.querySelector(".subweb-menu")),this.$subwebMenu.length&&(this.$rootMenu=$(_pageheader.querySelector(".rootweb-menu"))),window.ScreensizeHandler.isBigScreen&&null!==document.querySelector(".flexslider")?this.offsetTop=168:this.offsetTop=168,$(window).scroll(function(){this.handleTopMenu()}.bind(this)),this.$subwebMenu.length&&(this.timer=setTimeout(this.hideRootMenu.bind(this),3e3)))},handleTopMenu:function(){var scrollTop=$(window).scrollTop();if(this.$subwebMenu.length&&(scrollTop<=0?this.showRootMenu():this.hideRootMenu()),!(this.$pageheader.hasClass("menu-open")||this.scrollDisabled&&scrollTop>168)){if(scrollTop<0&&(scrollTop=0),scrollTop>=this.offsetTop?this.scrolled||(this.scrolled=!0,this.$pageheader.addClass(this.scrolledClass)):this.scrolled&&(this.scrolled=!1,this.$pageheader.removeClass(this.scrolledClass)),scrollTop>168&&scrollTop>=this.offsetTop){var bottomPos=scrollTop;ScreensizeHandler.isBigScreen&&(bottomPos=scrollTop-this.senseSpeed);var topPos=scrollTop;ScreensizeHandler.isBigScreen&&(topPos=scrollTop+this.senseSpeed),bottomPos>this.prevScrollTop?this.hidden||(this.hidden=!0,this.$pageheader.addClass(this.hideClass),this.disableScroll()):topPos<this.prevScrollTop&&this.hidden&&(this.hidden=!1,this.$pageheader.removeClass(this.hideClass),this.disableScroll())}else this.hidden&&(this.hidden=!1,this.$pageheader.removeClass(this.hideClass));this.prevScrollTop=scrollTop}},disableScroll:function(){this.scrollDisabled=!0,setTimeout(function(){this.scrollDisabled=!1}.bind(this),400)},hideRootMenu:function(){ScreensizeHandler.isBigScreen&&!this.rootMenuHidden&&(this.rootMenuHidden=!0,clearTimeout(this.timer),this.$rootMenu.stop(!0,!1).slideUp(),0==$(window).scrollTop()&&$(window).scrollTop(1))},showRootMenu:function(){ScreensizeHandler.isBigScreen&&this.rootMenuHidden&&(this.rootMenuHidden=!1,this.$rootMenu.stop(!0,!1).slideDown())}};$(window).on("load",function(){"undefined"!=typeof useMenuScrollEffect&&useMenuScrollEffect&&MenuScrollHandler.init()})}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var MobileMenuHandler={lastScrollPos:0,init:function(){var _menutoggle=document.querySelectorAll(".menu-toggle");null!==_menutoggle&&$(_menutoggle).on("click",function(e){e.stopPropagation();var $this=$(this);$this.toggleClass("open"),$this.find(".burger-container").toggleClass("active");var $target=$($this.data("target"));$target.toggleClass("open"),$(".page-header").toggleClass("menu-open"),$("body").toggleClass("no-scroll");var $content=$target.find(".content"),$blocker=$target.find(".blocker"),$triggers=$content.find(".accordion-trigger");$target.hasClass("open")?(MobileMenuHandler.checkNavHeight($target),$triggers.on("resize-start",function(){$blocker.height(0)}),$triggers.on("resize-end",function(){$blocker.height($content.outerHeight()),MobileMenuHandler.checkNavHeight($target)}),$blocker.on("click touchmove",function(e){return"click"==e.type&&$this.trigger("click"),!1}),$(window).on("resize.mobilemenu",function(){ScreensizeHandler.isBigScreen&&$this.trigger("click")})):($blocker.off("click touchmove"),$triggers.off("resize-start resize-end"),MobileMenuHandler.checkNavHeight($target,!0),$(window).off("resize.mobilemenu"))})},checkNavHeight:function($elem,reset){var $content=$elem.find(".content");if(reset)return void $content.off("touchmove touchstart");var $menuHeight=$elem.find(".accordion").outerHeight(),$windowHeight=$(window).outerHeight()-$(".page-header").outerHeight();$content.off("touchmove touchstart");var scrollTop=0;$menuHeight>$windowHeight?(scrollTop=$(window).scrollTop(),$elem.addClass("scroll"),$content.on("touchstart touchmove",function(e){$(window).scrollTop(scrollTop)})):($elem.removeClass("scroll"),$content.on("touchmove",function(e){return!1}))}};!function(){"undefined"!=typeof useMenuToggle&&useMenuToggle&&MobileMenuHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){ScreensizeHandler={screenSize:"",stateIndicator:null,isBigScreen:!1,isXlScreen:!1,isSmallScreen:!1,isLgOrSmaller:!1,isMdOrSmaller:!1,isPhOrSmaller:!1,isSmOrSmaller:!1,init:function(){this.stateIndicator=document.createElement("div"),this.stateIndicator.className="state-indicator",document.body.appendChild(this.stateIndicator),this.screenSize=this.getDeviceState(),$(window).resize(function(){var currentScreenSize=this.getDeviceState();currentScreenSize!=this.screenSize&&(this.screenSize=currentScreenSize)}.bind(this))},getDeviceState:function(){var index=parseInt(window.getComputedStyle(this.stateIndicator).getPropertyValue("z-index"),10),states={1:"",2:"xl",3:"lg",4:"md",5:"ph",6:"sm"},state=states[index];switch(this.isBigScreen=!1,this.isXlScreen=!1,this.isSmallScreen=!1,this.isLgOrSmaller=!1,this.isMdOrSmaller=!1,this.isPhOrSmaller=!1,this.isSmOrSmaler=!1,state){case"":this.isBigScreen=!0;break;case"xl":this.isBigScreen=!0,this.isXlScreen=!0;break;case"lg":this.isLgOrSmaller=!0,this.isSmallScreen=!0;break;case"md":this.isLgOrSmaller=!0,this.isMdOrSmaller=!0,this.isSmallScreen=!0;break;case"ph":this.isLgOrSmaller=!0,this.isMdOrSmaller=!0,this.isPhOrSmaller=!0,this.isSmallScreen=!0;break;case"sm":this.isLgOrSmaller=!0,this.isMdOrSmaller=!0,this.isPhOrSmaller=!0,this.isSmOrSmaller=!0,this.isSmallScreen=!0}return state}},function(){ScreensizeHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var SubMenuHandler={$submenus:null,init:function(){if(ScreensizeHandler.isBigScreen){var _submenus=document.querySelectorAll(".page-header li.has-child");null!==_submenus&&(this.$submenus=$(_submenus),this.positionSubmenus(),$(window).on("resize",this.positionSubmenus))}},positionSubmenus:function(){this.$submenus&&this.$submenus.each(function(){var $this=$(this),$subMenu=$(this.querySelector(".submenu")),marginLeft=$this.offset().left;$subMenu.css({left:-marginLeft});var $subMenuContent=$(this.querySelector(".submenu-content")),contentMargin=marginLeft+$this.width()/2-$subMenuContent.width()/2;contentMargin<40?contentMargin=40:contentMargin+$subMenuContent.width()>$(window).width()&&(contentMargin=$(window).width()-$subMenuContent.width()-40),$subMenuContent.css({"margin-left":contentMargin})})}};!function(){SubMenuHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){__webpack_require__(27);var SwipeboxHandler={$swipebox:null,init:function(){this.$swipebox=$(".swipebox"),this.$swipebox.length&&this.$swipebox.swipebox({useCSS:!0,useSVG:!0,hideCloseButtonOnMobile:!1,hideBarsDelay:3e3,videoMaxWidth:1024,beforeOpen:function(){$("body").addClass("no-scroll")},afterOpen:null,afterClose:function(){$("body").removeClass("no-scroll")},loopAtEnd:!1,removeBarsOnMobile:!1})}};!function(){"undefined"!=typeof useLightbox&&useLightbox&&SwipeboxHandler.init()}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function($){var vex=null,VexHandler={id:null,openVex:function(contentEl,setHeight){var marginTop=Math.round(contentEl.offsetHeight/2);contentEl.style.marginTop=-(marginTop+40)+"px",contentEl.style.marginLeft=-Math.round(contentEl.offsetWidth/2)+"px",$(contentEl).animate({marginTop:-marginTop},500),setHeight&&(contentEl.style.height=contentEl.offsetHeight+"px",contentEl.style.width=contentEl.offsetWidth+"px",contentEl.className+=contentEl.className?" open":"open"),"login"==this.id&&$("#login-loader").height($("#login-button").height());$(window).on("resize.vex",function(){$(window).off("resize.vex"),vex.closeAll()})},closeVex:function(contentEl){$(window).off("resize.vex");var marginTop=parseInt(contentEl.style.marginTop,10)-40;$(contentEl).animate({marginTop:marginTop+"px"},500)},setupModal:function(id){this.id=id;var _triggers=document.querySelectorAll('.modal-trigger[data-modal-template="'+id+'"]');if(null!==_triggers){var _this=this,template=document.querySelector("."+id+"-modal");template.remove(),$(template).removeClass("hide"),$(_triggers).on("click",function(e){$(this);return vex.defaultOptions.className="modal-"+id,vex.dialog.defaultOptions.buttons=[],vex.dialog.confirm({unsafeMessage:template,afterOpen:function(){_this.openVex(this.contentEl)},beforeClose:function(){_this.closeVex(this.contentEl)},callback:function(value){}}),!1})}}};!function(){if("undefined"!=typeof useModal&&useModal){if(vex=__webpack_require__(36),vex.registerPlugin(__webpack_require__(35)),vex.dialog.defaultOptions.showCloseButton=!0,"undefined"!=typeof useModalLogin&&useModalLogin){var loginVexHandler=$.extend({},VexHandler);loginVexHandler.setupModal("login")}if("undefined"!=typeof useModalAccount&&useModalAccount){var accountVexHandler=$.extend({},VexHandler);accountVexHandler.setupModal("account")}}}()}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_RESULT__;!function(){"use strict";/**  
