    ...
    $.swipebox = function(elem, options) {
					...
					<div id="swipebox-container">\
						...
						<div id="swipebox-bottom-bar">\
							<div id="swipebox-arrows">\
								<a id="swipebox-prev" class="icon-container"><span class="icon icon-play3"></span></a>\
        ...
        ui = {
            ...
            showBars: function showBars() {
                if (!plugin.settings.hideBarsDelay) return;

                var bars = $('#swipebox-top-bar, #swipebox-bottom-bar');
                if (this.doCssTrans()) {
                    bars.addClass('visible-bars');
                } else {
                    $('#swipebox-top-bar').fadeOut(200);
                    $('#swipebox-bottom-bar').fadeOut(200);
            ...
            hideBars: function hideBars() {
                ...
                if (this.doCssTrans()) {
                    ...
                    $('#swipebox-top-bar').fadeIn(200);
                    $('#swipebox-bottom-bar').fadeIn(200);
            ...
            setTitle: function setTitle(index) {
                ...
                if (title) {
                    ...
                    $('#swipebox-title').append('<p class="lightbox-title">' + title + '</p>');
                } else {
                    $('#swipebox-top-bar').hide();
                }
            },
